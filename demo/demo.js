...
function JSONGraph()
{
	graph.configure({
					nodes:[{type:"widget/button",pos:[950,200]},
						   ...
						   {type:"widget/button",pos:[100,450]},
						   {type:"basic/wrapper",pos:[250,500],properties:{name:"console.log", arguments:"msg"}},
						   {type:"basic/string",pos:[100,550],properties:{value:"the message"}},
