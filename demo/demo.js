...
function JSONGraph()
{
	graph.configure({
					nodes:[{type:"widget/button",pos:[950,150]},
						   ...
						   //For loop with break
						   {type:"widget/button",pos:[950,700]},
						   {type:"basic/number",pos:[950,750]},
						   {type:"basic/number",pos:[950,800],properties:{value:5}},
						   {type:"basic/forLoopWithBreak",pos:[1120,700]},
						   {type:"basic/console",pos:[1450,750]},
						   {type:"basic/string",pos:[1150,880],properties:{value:"finished"}},
						   {type:"basic/console",pos:[1300,860]},
						   {type:"math/condition",pos:[1300,790],properties:{OP:"<"}},
						   {type:"basic/number",pos:[1150,810],properties:{value:3}},
						   {type:"basic/branch",pos:[1300,700]},
						   {type:"graph/comment",pos:[900,450],size:[700,500],properties:{comment:"Examples with loops", color:"rgba(0,0,128,0.1)"}}],
					links:[{origin_id:0,origin_slot:0,target_id:1},
						   {origin_id:1,origin_slot:0,target_id:2},
						   ...
						   {origin_id:34,origin_slot:1,target_id:38},
						   {origin_id:39,origin_slot:0,target_id:38,target_slot:1},
						   {origin_id:38,origin_slot:0,target_id:40,target_slot:1},
